...
pkgdatadir = $(datadir)/as31
pkglibdir = $(libdir)/as31
pkgincludedir = $(includedir)/as31

top_builddir = ..

ACLOCAL = /home/sanjay/Documents/git/as31/a/as31-2.3.1/missing aclocal-1.4
AUTOCONF = autoconf
AUTOMAKE = /home/sanjay/Documents/git/as31/a/as31-2.3.1/missing automake-1.4
...
GUI_LIBS = 
LIBS = 
MAKEINFO = /home/sanjay/Documents/git/as31/a/as31-2.3.1/missing makeinfo
PACKAGE = as31
VERSION = 2.3.1
YACC = bison -y
...
DEFS = -DPACKAGE_NAME=\"\" -DPACKAGE_TARNAME=\"\" -DPACKAGE_VERSION=\"\" -DPACKAGE_STRING=\"\" -DPACKAGE_BUGREPORT=\"\" -DPACKAGE_URL=\"\" -DPACKAGE=\"as31\" -DVERSION=\"2.3.1\" -DOPTION_GTK=0 -I. -I$(srcdir) 
CPPFLAGS = 
LDFLAGS = 
...
CCLD = $(CC)
LINK = $(CCLD) $(AM_CFLAGS) $(CFLAGS) $(LDFLAGS) -o $@.html
man1dir = $(mandir)/man1
MANS = $(man_MANS)
